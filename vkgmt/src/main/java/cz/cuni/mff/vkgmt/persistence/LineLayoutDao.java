...
public class LineLayoutDao extends AbstractDao<LineLayout> {
	...
	private final Property FROM_TYPE = new Property(Constants.VKGMT_Prefix, "fromType");
	private final Property PROPERTY = new Property(Constants.VKGMT_Prefix, "property");
	private final Property TO_TYPE = new Property(Constants.VKGMT_Prefix, "toType");
