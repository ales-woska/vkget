 ...
 */
@RestController
public class RestLayoutController {
	 ...
	 * @inheritDoc
	 */
	@RequestMapping(value = "/rest/layout/save", method = RequestMethod.POST)
	 ...
	 * @inheritDoc
	 */
	@RequestMapping(value = "/rest/layout/remove", method = RequestMethod.POST)
